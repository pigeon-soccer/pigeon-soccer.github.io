      ...
      <div class="commonInner sectionContent">
        ...
        <section class="summary summary-atomosphere">
          ...
          <div class="summary__content">
            <div class="summary__txtWrapper">
              <div class="txtWrapper__txt">
                <p>単調になりがちな基礎練習も、コーチが雰囲気を作ることによって子どもの興味を刺激し、遊びの延長として自然に取り組んでいけるような現場作りをしていきます。教室は隔週で開催しており、練習では諦めずにトライすることを伝えます。SNSではそんな日々の活動の内容や、スタッフの気づきを報告しています。活動の雰囲気をつかみたい方はぜひ、ご覧ください。</p>
              </div>
            </div>
