...
<meta charset="utf-8">
  ...
  <meta name="description" content="2010年から東京都文京区で活動するNPO法人ピジョンのミッションと沿革。自閉症、ダウン症、発達障害などの子どもたちに、サッカーを通じて明るい心と社会性を育む場を提供。保護者・学校と連携し、一人ひとりの未来を支援します。">
      ...
      <div class="commonInner sectionContent commonInner-solution">
        ...
        <ul class="commonInner__solution">
          <li class="solution__list">
            <dl>
              <h3><dt>1. 子どもと保護者のコミュニティと成長の場の提供</dt></h3>
          ...
          <li class="solution__list">
            <dl>
              <h3><dt>2. 保護者・学校との連携による支援体制</dt></h3>
