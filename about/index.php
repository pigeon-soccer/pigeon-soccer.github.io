...
<head>
  ...
  <meta name="description"
    content="2010年から東京都文京区で活動するNPO法人ピジョンのミッションと沿革。自閉症、ダウン症、発達障害などの子どもたちに、サッカーを通じて明るい心と社会性を育む場を提供。保護者・学校と連携し、一人ひとりの未来を支援します。">
              ...
              <div class="paragraph">
                ...
                <div class="paragraph-content">
                  ...
                  <p>
                    ...
                    ところが、野球でもテニスでも、ダウン症などの知的障害、自閉症や多動症（ADHD）などの発達障害、および脳性まひなどの身体障害のある子どもを受け入れるチームはなかなか見つかりません。
                  ...
                  <p>
                    ...
                    この話を聞き、私たちは知的障害や発達障害のある子どもたちが安心して過ごせる居場所がいかに限られているかを痛感しました。
                  </p>
                </div>
              </div>
            </section>
            <section class="subSummary subSummary-connection">
              ...
              <div class="paragraph">
                ...
                <div class="paragraph-content">
                  ...
                  <p>
                    親にとって、子どもの自立は切実な課題です。しかし残念ながら、知的障害や発達障害のある子どもが大人になり、せっかく就職しても「人間関係がうまくいかない」「働く意欲や体力が続かない」「作業が合わない・適応できない」などの理由で、すぐに離職してしまうケースが多々あります。
            ...
            <section class="subSummary subSummary-connection">
              ...
              <div class="paragraph">
                ...
                <div class="paragraph-content">
                  ...
                  <p>
                    人は一人では生きていくことはできません。
                    しかし、多くの健康な子どもたちは、ダウン症などの知的障害、自閉症や多動症（ADHD）などの発達障害、および脳性まひなどの身体障がいのある子どもたちと接する機会がほとんどないまま、社会に出ていきます。
          ...
          <div class="commonInner sectionContent commonInner-solution">
            ...
            <ul class="commonInner__solution">
              <li class="solution__list">
                <dl>
                  <h3>
                    <dt>1. 子どもと保護者のコミュニティと成長の場の提供</dt>
                  </h3>
                  <dd>- 継続的な活動を通じて、障がいのある子どもたち、および保護者たちが仲間とつながり、笑顔になり、安心して過ごせるコミュニティを提供します。</dd>
                  <dd>- サッカーを通じて、社会性や自己管理能力を養育し、将来の自立と就労につなげます。</dd>
                </dl>
              </li>
              <li class="solution__list">
                <dl>
                  <h3>
                    <dt>2. 保護者・学校との連携による支援体制</dt>
                  </h3>
                  <dd>- 保護者や学校関係者と協力し、障がいのあるお子さまの特性に合わせた支援体制を築きます。</dd>
                  <dd>- 教育の専門家とも協力し、お子さまの可能性を最大限に引き出します。</dd>
                </dl>
              </li>
              <li class="solution__list">
                <dl>
                  <h3>
                    <dt>3. 社会との交流と障がいへの理解促進</dt>
                  </h3>
                  <dd>練習や地域活動（またはオンライン発信）を通じて、健常者の障がいへの理解を促します。</dd>
                  <dd>健常者が交流できる機会を作り、身近な体験から偏見と無理解を解消します。</dd>
                </dl>
              </li>
            </ul>
          ...
          <div class="commonInner sectionContent commonInner-history">
            ...
            <div class="commonInner__history">
              ...
              <dl>
                ...
                <dd class="history__summary">
                  <p class="txtLink txtLinkInline"><a href="https://todai-soccer.com/"
                      target="_blank">東京大学ア式蹴球部(サッカー部)</a>による支援（文京区における地域支援）が開始</p>
                </dd>
              </dl>
              <dl>
              ...
              <dl class="introduce__profile">
                ...
                <dd class="introduce__career">
                  <p class="txtLink txtLinkInline">
                    ...
                    また、福祉業界に従事する傍ら、幼児・小学生から社会人まで対応のサッカークラブ「<a href="http://ammaliatore.com/"
                      target="_blank">アンマリアトーレ</a>」（埼玉県川口市）
