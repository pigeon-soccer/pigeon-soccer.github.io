      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <p>
            ...
            <br>仕事もプライベートも、「自分に何ができるんだろう？」と探していたとき、
            <br>団体の副代表・鈴木さんに声をかけてもらったのがきっかけです。
            <br><span class="enrichText">サッカー経験もなく</span>、正直、<span class="enrichText">子どもとの接し方もよく分からない</span>ままのスタートでした。
            <br>
          ...
          <blockquote class="blockquoteDecoration normalFontWSize">
            <p>
              ...
              このように生徒には認知すべき障がいが現実としてあり、それに合わせた配慮が求められるからです。
              つまり生徒のより良い生活は、生徒自身の成長だけでなく、社会が「障がい」を認知・理解して取り除く事で初めて実現するのです。
            </p>
            <cite>
              大学生 男性
            </cite>
