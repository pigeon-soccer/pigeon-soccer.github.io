...
<body>
  ...
  <script defer src="../assets/js/join.js" loading="lazy"></script>
  <script defer src="../assets/js/form.js" loading="lazy"></script>
  <!-- Vendor JS Files -->
  <script defer src="../assets/vendor/purecounter/purecounter_vanilla.js" loading="lazy"></script>
  <script defer src="../assets/vendor/bootstrap/js/bootstrap.bundle.min.js" loading="lazy"></script>
  <script defer src="../assets/vendor/glightbox/js/glightbox.min.js" loading="lazy"></script>
  <script defer src="../assets/vendor/isotope-layout/isotope.pkgd.min.js" loading="lazy"></script>
  <script defer src="../assets/vendor/swiper/swiper-bundle.min.js" loading="lazy"></script>
  <script defer src="../assets/vendor/waypoints/noframework.waypoints.js" loading="lazy"></script>
  <script defer src="../assets/vendor/php-email-form/validate.js" loading="lazy"></script>
  <script defer src="https://sdk.form.run/js/v2/formrun.js" loading="lazy"></script>
