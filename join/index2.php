...
<head>
  ...
  <meta name="description"
    content="NPO「ピジョン」ではボランティアコーチの仲間を募集中。よく笑うこと・子どもとサッカーができる方を大歓迎。サッカー未経験OK。性別や単発稼働など問いません。お気軽にご連絡ください！">
                    ...
                    <div class="summaryInfo">
                      <dl>
                        ...
                        <dd class="summaryInfo__staffTarget">
                          ...
                          <img class="summaryInfo__staffTarget-img" src="../assets/img/snapshot/staff-inagon-art.png"
                            loading="lazy" alt="ボランティアスタッフとの練習風景 - 障がい児のためのサッカースクール">
                        </dd>
                      </dl>
                      <dl>
                        <dt>内容</dt>
